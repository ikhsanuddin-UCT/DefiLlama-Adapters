...
async function tvl(api) {
  ...
  tokens.forEach(object => {
    ...
    // Get the real_sui_reserves and real_token_reserves from the object
    const amount = object.fields.real_token_reserves

    // Add real_token_reserves to the calculation
...
module.exports = {
  ...
  methodology: "TVL is calculated from the total SUI and tokens locked in all suipump contract pools. The values are taken from the real_sui_reserves and real_token_reserves of each pool.",
};
